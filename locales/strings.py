...
STRINGS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "evento.created_id": "✅ Encuesta creada con ID **#{id}** — guárdalo para cerrarla con `/evento cerrar id:{id}`.",
        "evento.cerrar.not_found": "❌ No existe ningún evento con ID **{id}** en este servidor.",
        "evento.cerrar.already": "⚠️ El evento **#{id}** ya estaba cerrado.",
        "evento.cerrar.no_perms": "❌ Solo el creador del evento o un admin pueden cerrarlo.",
        "evento.cerrar.footer": "🔒 Encuesta cerrada — la votación ha terminado",
        "evento.cerrar.done": "🔒 Evento **{titulo}** (#{id}) cerrado. Los botones quedan desactivados.",
        ...
        "tribu.miembro.own_synced": "> 🏰 **Añadido a tu tribu propia** — aparece en el radar y no disparará alarmas.",
    ...
    "en": {
        ...
        "evento.created_id": "✅ Poll created with ID **#{id}** — keep it to close it with `/evento cerrar id:{id}`.",
        "evento.cerrar.not_found": "❌ No event with ID **{id}** exists on this server.",
        "evento.cerrar.already": "⚠️ Event **#{id}** was already closed.",
        "evento.cerrar.no_perms": "❌ Only the event creator or an admin can close it.",
        "evento.cerrar.footer": "🔒 Poll closed — voting has ended",
        "evento.cerrar.done": "🔒 Event **{titulo}** (#{id}) closed. Buttons are now disabled.",
        ...
        "tribu.miembro.own_synced": "> 🏰 **Added to your own tribe** — shows on the radar and won't trigger alarms.",
